import * as _gltf_transform_core0 from "@gltf-transform/core";
...
declare class StructuralMetadata extends ExtensionProperty<IStructuralMetadata> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IStructuralMetadata> & {
    schema: null;
    schemaUri: string;
    propertyTables: RefList<PropertyTable>;
    propertyTextures: RefList<PropertyTexture>;
...
declare class Schema extends ExtensionProperty<ISchema> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<ISchema> & {
    description: string;
    version: string;
    classes: RefMap<Class>;
    enums: RefMap<Enum>;
...
declare class Class extends ExtensionProperty<IClass> {
  ...
  parentTypes: ['Schema'];
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IClass> & {
    description: string;
    properties: RefMap<ClassProperty>;
  };
  getDescription(): string;
...
declare class ClassProperty extends ExtensionProperty<IClassProperty> {
  ...
  parentTypes: ['Class'];
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IClassProperty> & {
    description: string;
    componentType: null;
    enumType: null;
    array: null;
...
declare class Enum extends ExtensionProperty<IEnum> {
  ...
  parentTypes: ['Schema'];
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IEnum> & {
    description: string;
    valueType: string;
    values: RefList<EnumValue>;
  };
...
declare class EnumValue extends ExtensionProperty<IEnumValue> {
  ...
  parentTypes: ['Enum'];
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IEnumValue> & {
    description: null;
  };
  getDescription(): string;
  setDescription(description: string): this;
...
declare class PropertyTable extends ExtensionProperty<IPropertyTable> {
  ...
  parentTypes: ['StructuralMetadata'];
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IPropertyTable> & {
    properties: RefMap<ClassProperty>;
  };
  getClass(): string;
...
declare class PropertyTableProperty extends ExtensionProperty<IPropertyTableProperty> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IPropertyTableProperty> & {
    arrayOffsets: null;
    stringOffsets: null;
...
declare class PropertyTexture extends ExtensionProperty<IPropertyTexture> {
  ...
  parentTypes: ['StructuralMetadata'];
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IPropertyTexture> & {
    properties: RefMap<PropertyTextureProperty>;
  };
  getClass(): string;
...
declare class PropertyTextureProperty extends ExtensionProperty<IPropertyTextureProperty> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IPropertyTextureProperty> & {
    channels: number[];
    texture: null;
    textureInfo: TextureInfo;
    offset: null;
...
declare class PropertyAttribute extends ExtensionProperty<IPropertyAttribute> {
  ...
  parentTypes: ['StructuralMetadata'];
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IPropertyAttribute> & {
    properties: RefMap<PropertyAttributeProperty>;
  };
  getClass(): string;
  setClass(_class: string): this;
...
declare class PropertyAttributeProperty extends ExtensionProperty<IPropertyAttributeProperty> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IPropertyAttributeProperty> & {
    offset: null;
    scale: null;
    max: null;
    min: null;
...
declare class NodeStructuralMetadata extends ExtensionProperty<INodeStructuralMetadata> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<INodeStructuralMetadata> & {
    class: string;
    properties: {};
  };
  getClass(): string;
...
declare class MeshPrimitiveStructuralMetadata extends ExtensionProperty<IMeshPrimitiveStructuralMetadata> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IMeshPrimitiveStructuralMetadata> & {
    propertyTextures: RefList<PropertyTexture>;
    propertyAttributes: RefList<PropertyAttribute>;
  };
  listPropertyTextures(): PropertyTexture[];
...
declare class FeatureIDTexture extends ExtensionProperty<IFeatureIDTexture> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IFeatureIDTexture> & {
    channels: number[];
    texture: null;
    textureInfo: TextureInfo;
  };
...
declare class FeatureID extends ExtensionProperty<IFeatureID> {
  ...
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IFeatureID> & {
    nullFeatureId: null;
    label: string;
    attribute: null;
    texture: null;
 ...
 */
declare class RefList$1<T$1 extends GraphNode = GraphNode> {
  list: Ref<T$1>[];
 ...
 */
declare class RefSet$1<T$1 extends GraphNode = GraphNode> {
  set: Set<Ref<T$1>>;
  map: Map<T$1, Ref<T$1>>;
  constructor(refs?: Ref<T$1>[]);
  add(ref: Ref<T$1>): void;
 ...
 */
declare class RefMap$1<T$1 extends GraphNode = GraphNode> {
  map: {
    [key: string]: Ref<T$1>;
  };
...
type RefListKeys<T$1> = { [K in keyof T$1]-?: T$1[K] extends RefList$1 ? K : never }[keyof T$1];
type RefSetKeys<T$1> = { [K in keyof T$1]-?: T$1[K] extends RefSet$1 ? K : never }[keyof T$1];
type RefMapKeys<T$1> = { [K in keyof T$1]-?: T$1[K] extends RefMap$1 ? K : never }[keyof T$1];
type RefMapValue<Map$1> = Map$1 extends RefMap$1<infer V> ? V : never;
type RefCollectionValue<Collection> = Collection extends RefList$1<infer T> | RefSet$1<infer T> | RefMap$1<infer T> ? T : never; //#endregion
//#endregion
...
declare class Features extends ExtensionProperty<IFeatures> {
  ...
  parentTypes: [PropertyType.PRIMITIVE];
  protected init(): void;
  protected getDefaults(): _gltf_transform_core0.Nullable<IFeatures> & {
    featureIds: RefSet<GraphNode<object>>;
  };
