...
let MeshoptMode = /* @__PURE__ */ function(MeshoptMode) {
	MeshoptMode["ATTRIBUTES"] = "ATTRIBUTES";
	MeshoptMode["TRIANGLES"] = "TRIANGLES";
	MeshoptMode["INDICES"] = "INDICES";
	return MeshoptMode;
}({});
let MeshoptFilter = /* @__PURE__ */ function(MeshoptFilter) {
...
const DEFAULT_ENCODER_OPTIONS$1 = { method: EncoderMethod$1.QUANTIZE };
/**
